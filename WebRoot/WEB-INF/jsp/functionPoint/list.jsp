			...
			data-widget-custombutton="false">
				...
				<form:form action="functionPoint/list.do" cssClass="smart-form" commandName="functionPoint" onsubmit="return ajaxSearch(this,'${targetPanel}');">
					...
					<div class="dataTables_wrapper" style="border-bottom:1px solid #ddd;"> 
							...
							<tr>
								<th width="30%">
									<spring:message code="props.me.huqiao.smallcms.sys.entity.FunctionPoint.name"/>
								</th>
								<th>
									<spring:message code="props.me.huqiao.smallcms.sys.entity.FunctionPoint.url"/>
								</th>
								<th>
									<spring:message code="props.me.huqiao.smallcms.sys.entity.FunctionPoint.orderNum"/>:
								</th>
								<th width="10%">
