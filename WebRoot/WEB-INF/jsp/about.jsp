	  			...
	  			<div class="module-group">
		  			<div class="module left lg" style="width:1250px"><%--width:950px; --%>
		  				...
		  				<div class="module-content">
		  					<img alt="" src="${basePath}resource/frontend/theme/default/css/img/about-banner.png" style="width:100%;">
							...
							中国质量万里行促进会（英文简称CAQP）成立于1994年，前身是中国质量万里行组委会。
		  					...
		  					<img alt="" src="${basePath}resource/frontend/theme/default/css/img/about-banner-2.png"  style="width:100%;">
		  			 ...
		  			 <%-- <div class="module right blue" style="width:254px;">
		  				...
		  				<div class="module-content">
		  					...
		  					<p class="headerx" style="font-weight:bold;">电话：400-822-5757
		  					</p>
		  					</div>
